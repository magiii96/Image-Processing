%Repeat task 2a for color images
...
I_target1 = I_target(:,:,1);
I_source2 = I_source(:,:,2);
I_target2 = I_target(:,:,2);
I_source3 = I_source(:,:,3);
I_target3 = I_target(:,:,3);



imgresult = I_target;
imgresult(:,:,1) = importinggradient(I_source1,I_target1,Omega,target_x,target_y);
imgresult(:,:,2) = importinggradient(I_source2,I_target2,Omega,target_x,target_y);
imgresult(:,:,3) = importinggradient(I_source3,I_target3,Omega,target_x,target_y);

figure;
imshow(imgresult);
title('Result of Task3');

function imgresult = importinggradient(I_source,I_target,Omega,target_x,target_y)
